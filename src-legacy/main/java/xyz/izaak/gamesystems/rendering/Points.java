...
public class Points {
    ...
    public static final Vector3f GRAY = get(WHITE).mul(0.5f);
    ...
    public static Vector3f get(Vector3f original) {
        return new Vector3f(original);
    }

    public static Vector2f get(Vector2f original) {
        return new Vector2f(original);
    }

    public static FloatBuffer getBuffer(Matrix3f original) {
        FloatBuffer buffer = BufferUtils.createFloatBuffer(3 * 3);
        original.get(buffer);
        return buffer;
    }

    public static FloatBuffer getBuffer(Matrix4f original) {
        FloatBuffer buffer = BufferUtils.createFloatBuffer(4 * 4);
        original.get(buffer);
        return buffer;
    }

    public static FloatBuffer getBuffer(Vector4f original) {
        FloatBuffer buffer = BufferUtils.createFloatBuffer(4);
        original.get(buffer);
        return buffer;
    }

    public static FloatBuffer getBuffer(Vector3f original) {
        FloatBuffer buffer = BufferUtils.createFloatBuffer(3);
        original.get(buffer);
        return buffer;
    }

    public static FloatBuffer getBuffer(Vector2f original) {
