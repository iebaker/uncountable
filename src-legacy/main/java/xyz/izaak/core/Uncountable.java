...
import xyz.izaak.gamesystems.architecture.ArchitectureSystem;
import xyz.izaak.gamesystems.rendering.Shaders;
import xyz.izaak.gamesystems.texture.TextureSystem;
import xyz.izaak.gamesystems.GameSystem;
import xyz.izaak.gamesystems.cameracontrol.CameraControlSystem;
import xyz.izaak.gamesystems.quit.QuitSystem;
import xyz.izaak.gamesystems.rendering.Points;
import xyz.izaak.gamesystems.rendering.RenderingSystem;
...
public class Uncountable {
     ...
     */
    public Uncountable() {
        System.setProperty("java.library.path", "lib/lwjgl/natives");
    ...
    private void initGraphics() {
        try {
            ...
            Shaders.createShader("stenciler", "shaders/stenciler.vert", "shaders/stenciler.frag");
            Shaders.createShader("solid", "shaders/solid.vert", "shaders/solid.frag");
        } catch (IOException e) {
            e.printStackTrace();
        }
