...
/**
 * Native bindings to the <a href="http://www.khronos.org/registry/cl/extensions/intel/cl_intel_thread_local_exec.txt">intel_thread_local_exec</a> extension.
 * 
 * <p>This extension allows the user to execute OpenCL tasks and kernels with the user core's threads. The extension defines a token that can be passed
 ...
 * events. A non-{@code NULL} event dependency list will block the caller core thread until all the corresponding events are completed. Output events will
 ...
 * and have the exact same impact on the core. Calls to {@link CL10#clFinish Finish} and {@link CL10#clFlush Flush}, {@link CL10#clEnqueueBarrier EnqueueBarrier} and
