...
/**
 * Native bindings to the <a href="http://www.opengl.org/registry/specs/ARB/seamless_cubemap_per_texture.txt">ARB_seamless_cubemap_per_texture</a> extension.
 * 
 ...
 * per-face cube map sampling modes during sampling. Furthermore, if an core included cube maps that were meant to be sampled seamlessly and
