 ...
 * 
 * <p>This extension allows the GL to notify applications when various events occur that may be useful during core development, debugging and
 * profiling.</p>
 * 
 ...
 * about undefined behavior or notifications identifying that the core is within a specific section of the core code.</p>
 * 
 ...
 * combination of source and type, through the entire core code or only section of the code encapsulated in debug groups. A debug group may also be
 * used to annotate the command stream using descriptive texts.</p>
 * 
 * <p>This extension also defines debug markers, a mechanism for the OpenGL core to annotate the command stream with markers for discrete events.</p>
 * 
 * <p>When profiling or debugging an OpenGL core with a built-in or an external debugger or profiler, it is difficult to relate the commands within the
 ...
 * section of an core code providing an effective way to handle the massive amount of debug outputs that drivers can generate.</p>
 * 
 ...
 * 
 * <p>When profiling or debugging an OpenGL core within an external or built-in (debut output API) debugger or profiler it is difficult to identify
 ...
 * 
 * <p>The intended purpose of this extension is purely to improve the user experience within OpenGL development tools and core built-in profilers and
 ...
 * giving him more time to focus on adding new features to an OpenGL core.</p>
 * 
