 ...
 * 
 * <p>This extension allows an core to specify a minimum periodicity of color buffer swaps, measured in video frame periods, for a particular drawable.
 * It also allows an core to query the swap interval and the implementation-dependent maximum swap interval of a drawable.</p>
 */
